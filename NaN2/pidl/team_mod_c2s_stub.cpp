...
#include "team_mod_c2s_stub.h"


const unsigned char sz_team_mod_c2s_stub_hRmi[] = 
...
namespace team_mod_s2c {
	...
	bool Stub::ProcessReceivedMessage(::Proud::CReceivedMessage &pa, void* hostTag) 
	{
#ifndef __FreeBSD__ 
		{
			...
			unsigned char x = sz_team_mod_c2s_stub_hRmi[0]; 
			x++; 
		}
#endif
			...
			case Rmi_JoinTeam:
				{
					...
					int team; __msg >> team;
					m_core->PostCheckReadMessage(__msg,RmiName_JoinTeam);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_JoinTeam, 
							RmiName_JoinTeam,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_JoinTeam, 
							RmiName_JoinTeam, parameterString);
			#endif
					}
					...
					if(!m_internalUse && m_enableStubProfiling)
					{
						...
						summary.m_rmiID = (::Proud::RmiID)Rmi_JoinTeam;
						summary.m_rmiName = RmiName_JoinTeam;
					...
					if(__ret==false)
					{
						...
						m_core->ShowNotImplementedRmiWarning(RmiName_JoinTeam);
					}
...
__fail:
	...
	const PNTCHAR* Stub::RmiName_JoinTeam =_PNT("JoinTeam");
	#else
	const PNTCHAR* Stub::RmiName_JoinTeam =_PNT("");
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_JoinTeam;
